...
def generate_haruhi_response(user_query, finetune_model_path, base_model_name_or_path) -> str:
...
if __name__ == "__main__":
    ...
    # 获取并打印结果
    result_msg = generate_haruhi_response(user_input, finetune_model_path, base_model_name_or_path)
